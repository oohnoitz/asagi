...
import net.easymodo.asagi.model.vichan.PageJson;
import net.easymodo.asagi.model.vichan.PostJson;
import net.easymodo.asagi.model.vichan.TopicJson;
import net.easymodo.asagi.model.vichan.TopicListJson;
...
@ThreadSafe
public class vichanJSON extends YotsubaAbstract {

    public vichanJSON(String boardName, SiteSettings siteSettings, BoardSettings boardSettings) {
        super(vichanJSON.getBoardLinks(boardName, siteSettings));
    ...
    private Post makePostFromJson(PostJson pj) throws ContentParseException {
        ...
        if(pj.getFilename() != null) {
            ...
            p.setPreviewOrig(pj.getTim() + pj.getExt());
        }
